...
function LoginUser() {
  ...
  return (
    <section className="relative">
      ...
      <section className="">
      <form onSubmit={(e)=>loginUser(e)} className="bg-white max-w-sm	rounded-lg shadow-md py-8 px-5">
        <h1 className="text-2xl font-bold w-screen">Login</h1>
        <p className="text-gray-400">
          Doesn't have an account yet?
          <Link to="RegisterUser" className="text-indigo-700 underline ml-1">Sign Up</Link>
        </p>
        ...
        <button type="submit" className="mt-4 btn font-bold w-full">LOGIN</button>
